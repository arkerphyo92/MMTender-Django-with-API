...
SECRET_KEY = 'django-insecure-+io(t@v#uhqk1$09or!h(x=4_e*#sbvw*fb!zj(fiwhri21g28'
...
CKEDITOR_CONFIGS = {
    'default': {
        'toolbar': [
            ...
            ['Link', 'Unlink', 'Anchor'],
            ['TextColor', 'BGColor'],  # Text and background color options
...
CKEDITOR_UPLOAD_PATH = 'tenders/ckeditor/'